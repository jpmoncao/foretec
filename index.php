...
<body>
    ...
    <article class="return">
        <section class="qualites">
            <h2>Experimente o For<span class="title-red">Etec</span></h2>
            <div>
                <span>
                    <span>✅</span>
                ...
                <span>
                    <span>✅</span>
                    <p>Conecte-se com seus professores</p>
                </span>
            </div>
        </section>
    ...
    <footer>
        ...
        <section class="footer-links">
                <ul>
                    ...
                    <li><a href="#">Google page</a></li>
                </ul>
                <ul>
                    <li class="title">Colaboradores</li>
                    <li><a href="#">Etec Fernandópolis</a></li>
                    <li><a href="#">Thaís Carrera</a></li>
                    <li><a href="#">João Lucatto</a></li>
                </ul>
                <ul>
                    <li class="title">Desenvolvedores</li>
                    <li><a href="#">Figma</a></li>
                    <li><a href="#">Open Source</a></li>
                    <li><a href="#">Github</a></li>
                </ul>
                <ul>
                    <li class="title">Criadores</li>
                    <li><a href="#">Davi Souza</a></li>
                    <li><a href="#">Gabriel Monteiro</a></li>
                    <li><a href="#">Higor Donda</a></li>
                    <li><a href="#">João Pedro Monção</a></li>
                </ul>
                <ul>
                    <li class="title">Documentação</li>
                    <li><a href="#">Artigo Word</a></li>
        ...
        <section class="footer-end">
            ...
            <aside>Disponível em todos os aparelhos</aside>
        </section>
    </footer>
</body>
