...
<html lang="pt-br">
    ...
    <body class="humanas">
        ...
        <main>
            <?php if(isset($_GET['materiais'])) {
                include('./material.php'); 
            } elseif(isset($_GET['atividades'])) {
                include('./atividades.php'); 
            } else { ?>
            <section>
                <article class="text">
                    <a href="../home.php"><button>VOLTAR</button></a>
                    <h1>Bem-vindo a sessão de <span class="text-color">história!</span></h1>
                    <p>Atividades a serem realizadas</p>
                </article>
                <article class="div-streak">
                    <p class="streak-number">7</p>
                </article>
                <article class="container-buttons">
                    <a href="?materiais"><button>MATERIAIS DE APOIO</button></a>
                    <a href="?atividades"><button class="acess">ACESSAR ATIVIDADES</button></a>
                </article>
            </section>
            <?php } ?>
        </main>
